const CAVALOS = ["Marujos", "Tordilho", "Belgas", "Twister", "Jade", "Lucky"];

var apostas = [];

function adicionarAposta(){
    var inValor = document.getElementById("inValor");
    var outApostas = document.getElementById("inValor");
...
function mostrarCavalo(){
    ...
    var numApostas = contarApostar(cavalo);
...
function contarApostar(numCavalo){
    var contador = 0;
    for (var i = 0; i < apostas.length; i++){
...
function ganhadorPareo(){
    ...
    resumo += "---------------------------\n"
    resumo += "Nº de apostas: " + contarApostar(ganhador) + "\n";
