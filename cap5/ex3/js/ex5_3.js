...
function listarCarros(){
    ...
    for(var i = 0; i < carros.length; i++){
        lista += carros[i].modelo + " - R$: " + carros[i].preco.toFixed(2) + "<br>";
    }
...
function filtrarCarros(){
    var maximo = Number(prompt("Qual o valor máxio que o cliente deseja pagar?"));
    ...
    if(lista == ""){
        ...
        outLista.innerHTML = "Carros até R$ " + maximo.toFixed(2) + 
        "<br>-----------------------------------------<br>" + lista;
    }
}
